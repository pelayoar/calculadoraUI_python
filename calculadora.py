...
e_texto.grid(row=0, column=0, columnspan=4, padx=5, pady=10)

#FUNCIONES
def click_boton(valor):
    global i
    e_texto.insert(i, valor) #primer parametro indice donde se introduce
    i+=1
    
def borrar():
    e_texto.delete(0, END) #desde indice 0 hasta el final
    i=0
